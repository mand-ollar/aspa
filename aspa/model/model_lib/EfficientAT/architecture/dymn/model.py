...
from ..mn.block_types import InvertedResidual
from .dy_block import DY_Block, DynamicConv, DynamicInvertedResidualConfig
...
class DyMN(nn.Module):
    def __init__(
        ...
        **kwargs: Any,
        ...
        if not inverted_residual_setting:  # check if inverted_residual_setting is empty
        ...
        if self.head_type == "fully_convolutional":
            ...
            raise NotImplementedError(
                f"Head '{self.head_type}' unknown. Must be one of: 'mlp', 'fully_convolutional', 'multihead_attention_pooling'"
            )
